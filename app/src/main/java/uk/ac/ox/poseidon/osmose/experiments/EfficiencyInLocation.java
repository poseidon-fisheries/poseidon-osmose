...
import uk.ac.ox.poseidon.osmose.OsmoseMapInitializerFactory;
...
public class EfficiencyInLocation {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ((DailyDecreasingProbabilityFactory) probabilities[1]).setExplorationProbabilityMinimum(new FixedDoubleParameter(
            0.01d));
